...
public class FormularioController {
    ...
    @PostMapping("/upload")
    public String uploadFile(@RequestParam("arquivo") MultipartFile file, RedirectAttributes attributes, RequisicaoNovoCsv requisicao) throws IOException {
        ...
        System.out.println((((file.getSize()) / 1024) / 1024) + " Mb"); //manda no console o tamanho do arquivo em Mb
